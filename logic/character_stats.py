...
class CharacterStats:
    ...
    def __init__(self, strength: int, strength_dm: int, dexterity: int, dexterity_dm: int,
                 endurance: int, endurance_dm: int, intelligence: int,
                 intelligence_dm: int, education: int, education_dm: int, iq: int,
                 social_standing: int, social_standing_dm: int, height: int, mass: int,
                 skin_tone: str, hair_color: str, eye_color: str, soc_class: str,
                 soc_desc_title: str) -> None:
...
def gen_char_stats() -> CharacterStats:
    ...
    return CharacterStats(strength, strength_dm, dexterity, dexterity_dm, endurance,
                          endurance_dm, intelligence, intelligence_dm, education,
                          education_dm, iq, social_standing, social_standing_dm, height,
                          mass, skin_tone, hair_color, eye_color, soc_class,
                          soc_desc_title)
