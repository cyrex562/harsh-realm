...
def gen_soc_standing(soc: int) -> Tuple[str,str]:
    if soc == 0:
        return ("No social class", "fugitive wanted for exceptionally repugnant crimes; no contact with civilization")
    elif soc == 1:
        ...
        return ("middle class", "educated or respected professional/executive; a distant relative of a noble family")
    elif soc == 10:
...
class CharacterStats:
    ...
    def __init__(self, strength: int, strength_dm: int, dexterity: int, dexterity_dm: int, endurance: int, endurance_dm: int, intelligence: int, intelligence_dm: int, education: int, education_dm: int, iq: int, social_standing: int, social_standing_dm: int, height: int, mass: int, skin_tone: str, hair_color: str, eye_color: str, soc_class: str, soc_desc_title: str) -> None:
...
def gen_character_stats() -> CharacterStats:
    ...
    return CharacterStats(strength,strength_dm,dexterity,dexterity_dm,endurance,endurance_dm,intelligence,intelligence_dm,education,education_dm,iq,social_standing,social_standing_dm,height,mass,skin_tone,hair_color,eye_color,soc_class,soc_desc_title)
